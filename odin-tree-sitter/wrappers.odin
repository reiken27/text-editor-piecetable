...
parser_parse_string_encoding :: #force_inline proc(
	...
	return _parser_parse_string_encoding(
		self,
		old_tree,
		strings.unsafe_string_to_cstring(string),
		u32(len(string)),
...
language_symbol_for_name :: #force_inline proc(
	...
	return _language_symbol_for_name(
		self,
		strings.unsafe_string_to_cstring(string),
		u32(len(string)),
		is_named,
...
language_field_id_for_name :: #force_inline proc(self: Language, name: string) -> Field_Id {
	return _language_field_id_for_name(
		self,
...
wasm_store_load_language :: #force_inline proc(
	...
	lang = _wasm_store_load_language(
		self,
		name,
